...
const Card1 = () => {
    ...
    return (
        <div>
            ...
            <div
                ref={containerRef}
                className="md:flex md:items-center md:justify-center px-5 md:px-20 md:pt-60 py-30 gap-10"
            >
                <div
                    className={`
                ...
                <div className="w-[100%] mt-5">
                    ...
                    <p
                        ...
                        `}
                    >
                        Unlock the true potential of your videos with our expert video editing services. We cater to content
                        creators, businesses, and individuals looking to enhance their footage into polished works of art.
                        Our skilled editors utilize the latest tools and techniques to create stunning visual narratives
                        that engage viewers. Whether you need a quick turnaround for social media content or a detailed
                        edit for a corporate presentation, we tailor our approach to meet your unique needs. Experience
                        the difference that professional editing can make for your projects.
                    </p>
